...
export type Entity = Repo | RepoCommit | RepoAuth | Suite | SuiteEnv | SuiteTest | User
export const Entities: Array<new () => Entity> = [Repo, RepoCommit, RepoAuth, Suite, SuiteEnv, SuiteTest, User]
